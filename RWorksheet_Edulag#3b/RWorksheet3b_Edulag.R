...
#b. Describe the data. Get the structure or the summary of 
#the data
...
#d. Extract the 1st two rows and then all the columns using 
#the subsetting functions. 
...
#f. Select the variable types of houses then store the vector 
#that results as types_houses. Write the codes.
...
#h. Select only all females respondent that have greater than
#or equal to 5 number of siblings attending school. 
...
T_SentimentTwts <- print ("My interpretation of the graph that shows Donald Trump's daily sentiments in his tweets is that each day, the count of negative sentiments prevails, which indicates that there are significantly more negative sentiments than positive or neutral ones. Positive rankings came next, and they were followed by neutral rankings. To sum up, a large portion of Twitter users dislike Donald Trump as a politician, 
                          which explains their unfavorable views of him.")
T_SentimentTwts
