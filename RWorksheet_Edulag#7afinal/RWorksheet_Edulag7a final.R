...
library("readxl")
b_cancer <- read_excel("C:\\Users\\user\\Desktop\\JEODALYN\\Jezyo_repo//Breast_Cancer.xlsx")
b_cancer
#c. Compute the descriptive statistics using different packages. Find the values of:
#c.1 Standard error of the mean for clump thickness.
num8c1.n <- length(b_cancer$`CL. thickness`)
num8c1.sd <- sd(b_cancer$`CL. thickness`)
num8c1.se <- num8c1.sd/sqrt (b_cancer$`CL. thickness`)
num8c1.se
...
dcribe(b_cancer$V11, na.rm =TRUE)
